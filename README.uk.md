...
Застосунок надає базову функіональність для веб-застосунка, що дозволяє відстежувати та керувати споживанням води щоденно.
...
Приклади використання функції бекенду:
...
Ці кінцеві шляхи дозволяють використовувати функції програми.
